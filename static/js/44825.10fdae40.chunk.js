...
joinDisplacementDir = perpendicular(joinDisplacementDir);`);const k=w!==b.x.BUTT;return x.main.add(S.H`
...
vec2(vStippleDistanceLimits.x, 1e34);`)),x.main.add(S.H`
    ...
    }`),t.fragment.include(n.HQ,e),t.include(A.z,e),L.include(p.a),L.main.add(S.H`discardBySlice(vpos);
...
finalColor.a *= 1.0 - clamp(feather, 0.0, 1.0);`)),L.main.add(S.H`outputColorHighlightOID(finalColor, vpos);`),t}const x=Object.freeze(Object.defineProperty({__proto__:null,build:E,ribbonlineNumRoundJoinSubdivisions:C},Symbol.toStringTag,{value:"Module"}))},17698:(e,t,i)=>{i.d(t,{r:()=>l});var r=i(99443),n=i(3799),o=i(23148),a=i(86955),s=i(50125);function l(e,t){const i=e.vertex;(0,n.Nz)(i),null==i.uniforms.get("markerScale")&&i.constants.add("markerScale","float",1),i.constants.add("markerSizePerLineWidth","float",r.PV).code.add(a.H`float getLineWidth() {
