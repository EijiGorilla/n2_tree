...
posProj = alignToPixelOrigin(posProj, viewport.zw);
    ...
    bool alphaDiscard = vcolor.a < ${E.H.float(w.Q)};
    ${(0,E.If)(o,`alphaDiscard = alphaDiscard && outlineColor.a < ${E.H.float(w.Q)};`)}
    if (alphaDiscard) {
    ...
    vsize = inputSize;
  `),B.uniforms.add(new y.N("tex",(e=>e.texture))),e.occludedFragmentFade&&(B.uniforms.add(new z.x("depthMap",(e=>e.mainDepth))),B.uniforms.add(new x.U("occludedOpacity",(e=>e.hudOccludedFragmentOpacity))));const W=e.debugDrawLabelBorder?E.H`(isBorder > 0.0 ? 0.0 : ${E.H.float(w.Q)})`:E.H.float(w.Q),q=E.H`
    ...
    ${o?E.H`
      ...
      if (outlineSize > 0.25) {
        ...
        if (
          ...
          fillPixelColor.a + outlinePixelColor.a < ${E.H.float(w.Q)}
        ) {
          discard;
        }
  ...
  `;switch(F){case n.V.Color:case n.V.ColorEmission:t.outputs.add("fragColor","vec4",0),F===n.V.ColorEmission&&t.outputs.add("fragEmission","vec4",1),L===I.Y.ColorAlpha&&t.outputs.add("fragAlpha","float",F===n.V.ColorEmission?2:1),B.main.add(E.H`
        ${q}
        ${(0,E.If)(L===I.Y.FrontFace,E.H`fragColor.rgb /= fragColor.a;`)}
        ${(0,E.If)(F===n.V.ColorEmission,E.H`fragEmission = vec4(0.0);`)}
        ${(0,E.If)(L===I.Y.ColorAlpha,E.H`fragAlpha = fragColor.a;`)}`);break;case n.V.ObjectAndLayerIdColor:B.main.add(E.H`
        ${q}
        outputObjectAndLayerIdColor();`);break;case n.V.Highlight:t.include(h.Q,e),B.main.add(E.H`
        ${q}
        outputHighlight(${(0,E.If)(U,E.H`voccluded == 1.0`,E.H`false`)});`)}return t}function R(e){return e.outlineColor[3]>0&&e.outlineSize>0}function N(e){return e.textureIsSignedDistanceField?(t=e.anchorPosition,o=e.distanceFieldBoundingBox,r=H,(0,i.hZ)(r,t[0]*(o[2]-o[0])+o[0],t[1]*(o[3]-o[1])+o[1])):(0,i.C)(H,e.anchorPosition),H;var t,o,r}const H=(0,r.vt)(),L=Object.freeze(Object.defineProperty({__proto__:null,build:F,calculateAnchorPosition:N},Symbol.toStringTag,{value:"Module"}))},38280:(e,t,o)=>{o.d(t,{I:()=>s});var i=o(98720),r=o(94192),a=o(86955);function s(e,t){const{vertex:o,fragment:s}=e;e.include(r.Z,t),o.include(i.K),o.main.add(a.H`vec4 posProjCenter;
